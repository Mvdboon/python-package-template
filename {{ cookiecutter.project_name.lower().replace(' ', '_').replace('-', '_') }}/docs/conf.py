...
_toml = tomlkit.loads((_root / "pyproject.toml").read_text(encoding="utf8")) # type: ignore
...
copyright = find("tool.poetry.copyright")
# _license = find("tool.poetry.license")
# _license_url = find("tool.poetry.license_url")
